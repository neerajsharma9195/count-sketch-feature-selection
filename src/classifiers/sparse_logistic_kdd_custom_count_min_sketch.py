...
from src.processing.parse_data import process_data, process_line
import os
import math
...
if __name__ == '__main__':
    ...
    for top_k in top_k_size:
        ...
        with open(filePath, 'r') as f:
            for line in f:
                ...
                train_i += 1
        end_time = time.time()
        with open("topk_kdd_custom_count_min_sketch_size_{}.txt".format(top_k), 'w') as f:
    ...
    with open("kdd_custom_count_min_results.json", 'w') as result_file:
