...
if __name__ == '__main__':
    ...
    lgr = LogisticRegression(count_sketch_size=count_sketch_size, top_k=10000, top_k_dict=top_k_dict)
    ...
    with open("../results/topk_feature_gradients_complementary_count_min_all_topk_8000.json", 'w') as f:
